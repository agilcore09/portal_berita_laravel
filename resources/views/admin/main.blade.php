...
<head>
    ...
    <link href="{{ asset('/lib/admin/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
    ...
    <script src="{{ asset('/lib/admin/vendor/jquery-easing/jquery.easing.min.js') }}"></script>
